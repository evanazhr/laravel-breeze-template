                ...
                <div class="p-6 overflow-x-auto">
                    ...
                    <form method="POST" action={{ route('products.update', $product) }} class="mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input name="name" placeholder="contoh : Laptop"
                        ...
                        <div>
                            ...
                            <x-text-input name="price" placeholder="contoh : 10.000"
                        ...
                        <div>
                            ...
                            <x-text-input name="stock" placeholder="contoh : 10"
                                value="{{ old('stock', $product->stock) }}" class="w-full" required />
